...
The project attempts to use SHAP DeepExplainer.
However, recent TensorFlow versions produce errors such as:

gradient registry has no entry for: shap_TensorListStack


Therefore, the pipeline automatically falls back to:
